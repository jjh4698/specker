    ...
    render(){
        return(
            <div className="classification-background">
                ...
                <div className="classification-logo row">목표 선택</div>
                <div className="classification-msg row">정보를 받아보고 싶은 목표태그를 검색해 자유롭게 선택해주세요.</div>
                <div className="classification-msg row">*최소 3개 입력, 마이페이지에서 변경가능</div>
